...
exports.Order = exports.OrderPaymentMethod = exports.OrderStatus = void 0;
...
(function (OrderPaymentMethod) {
    OrderPaymentMethod["DEPOSIT"] = "DEPOSIT";
    OrderPaymentMethod["CREDIT"] = "CREDIT";
...
], Order.prototype, "tournament", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'tournament_id', nullable: true }),
    __metadata("design:type", String)
], Order.prototype, "tournamentId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: OrderStatus,
